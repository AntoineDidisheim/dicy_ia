...
p = 0  # latter on to loop on p (number of pass in a round)
...
print("bet",bet,"follow",follow)
print("res =",res)
print(pl1.current_score,pl2.current_score)
print("cards played: ",game.card_played)
